...
// import ServicesSection from "../PhysicalSecurity/ServicesSection";
  
//   const DigitalSlider = () => {
//     const slides = [
//       { id: 1, image: "../assets/Images/guardb.jpg" }, 
//       { id: 2, image: "../assets/Images/tec.jpg" }, 
//       // { id: 3, image: "../assets/Images/cmo.jp"}, 
...
//         </div>
//       </div>
// <section className="w-full bg-[#6B4226] text-white py-16 flex flex-col items-center text-center px-6">
//   {/* Heading */}
//   <motion.h2
...
//   >
// All-in-One Digital Security Solutions
//   </motion.h2>
...
//       >
//   Our digital security services cover every aspect of protection — from threat monitoring and incident response to cloud security, IAM, and compliance. Shehrity ensures your business remains secure in today’s evolving digital landscape.
//       </motion.p>
...
//         }}
//         whileTap={{ scale: 0.95 }}
//         className=" text-blue-900 font-semibold px-8 py-3 rounded-full shadow-md transition-colors duration-300 hover:bg-blue-700 hover:text-black !no-underline"
//       >
...
import ServicesSection from "../PhysicalSecurity/ServicesSection";
  ...
  <>
      ...
      <div className="relative w-full overflow-hidden rounded-lg">
        ...
        {/* Overlay Text */}
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 !bg-green/60 text-white">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
           Digital Security Services
          </h1>
          <p className="text-lg md:text-xl max-w-3xl">
