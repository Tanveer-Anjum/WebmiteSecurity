...
const DigitalHeroSection = ({isDigitalSecurityActive }) => {
  ...
  <button
    className={`px-5 py-2.5 rounded-full transition text-sm font-bold text-black !border-2 !border-red-950
      ${isDigitalSecurityActive 
...
//           <button
//             className={`
//               px-5 py-2.5 rounded-full transition text-sm font-semibold
//               ${isDigitalSecurityActive
//                 ? "!bg-[#702829] hover:bg-[#5a2021] text-white" // brown
//                 : "bg-[#15487d] hover:bg-blue-950 text-white" // blue
//               }
//             `}
//             style={{ fontFamily: "Arial, sans-serif" }}
//           >
...
//           <button
//             className={`
//               px-5 py-2.5 rounded-full transition text-sm font-bold
//               ${isDigitalSecurityActive
//                 ? "bg-white text-black hover:bg-gray-200 border border-[#702829]" // white in digital
//                 : "bg-[#15487d] hover:bg-gray-900 text-white border border-blue-900" // blue in physical
//               }
//             `}
//             style={{ fontFamily: "Arial, sans-serif" }}
//           >
